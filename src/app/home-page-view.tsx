...
const defaultStudentStoryVideos: HomeVideoItem[] = [
...
const defaultAboutVideoMarkup = `<div class="about-video-card">
  <iframe
...
const defaultHeroShowcaseMarkup = buildHeroShowcaseMarkup([], null);
...
const categoryStripMarkup = `<section class="cat-strip" id="categories" aria-label="Explore exam categories">
  <a href="/courses" class="cat-chip">
    ...
    <span class="cat-chip-meta"><b>Banking Exams</b><small>220+ Courses</small></span>
  </a>
  <a href="/courses" class="cat-chip">
    <span class="cat-ic c2"><i class="fa fa-pen-ruler"></i></span>
    <span class="cat-chip-meta"><b>SSC Exams</b><small>180+ Courses</small></span>
  </a>
  <a href="/courses" class="cat-chip">
    <span class="cat-ic c3"><i class="fa fa-train"></i></span>
    <span class="cat-chip-meta"><b>Railway Exams</b><small>150+ Courses</small></span>
  </a>
  <a href="/courses" class="cat-chip">
    <span class="cat-ic c4"><i class="fa fa-chalkboard-user"></i></span>
    <span class="cat-chip-meta"><b>Teaching Exams</b><small>120+ Courses</small></span>
  </a>
  <a href="/courses" class="cat-chip">
    <span class="cat-ic c5"><i class="fa fa-landmark-dome"></i></span>
    <span class="cat-chip-meta"><b>UPSC Exams</b><small>100+ Courses</small></span>
  </a>
  <a href="/courses" class="cat-chip">
    <span class="cat-ic c6"><i class="fa fa-map-location-dot"></i></span>
    <span class="cat-chip-meta"><b>State Exams</b><small>90+ Courses</small></span>
  </a>
</section>`;

const examCategoriesMarkup = `<section class="achieve-strip">
  <div class="achieve-item"><span class="achieve-ic"><i class="fa fa-user-graduate"></i></span><div><strong>12L+</strong><small>Happy Students</small></div></div>
  <div class="achieve-item"><span class="achieve-ic"><i class="fa fa-chalkboard-user"></i></span><div><strong>5000+</strong><small>Top Educators</small></div></div>
  <div class="achieve-item"><span class="achieve-ic"><i class="fa fa-file-pen"></i></span><div><strong>30000+</strong><small>Mock Tests</small></div></div>
  <div class="achieve-item"><span class="achieve-ic"><i class="fa fa-trophy"></i></span><div><strong>95%</strong><small>Success Rate</small></div></div>
  <div class="achieve-item"><span class="achieve-ic"><i class="fa fa-headset"></i></span><div><strong>24/7</strong><small>AI Support</small></div></div>
</section>

<section class="offer-bar">
  <div class="offer-left">
    <span class="offer-flame"><i class="fa fa-fire"></i> Limited Time Offer</span>
    <h3>Get <em>50% OFF</em> on All Courses</h3>
    <p><i class="fa fa-clock"></i> Offer valid till 31st December 2026</p>
  </div>
  ...
  <div class="offer-right">
    <div class="offer-code"><small>Use Code:</small><b>LEARN50</b></div>
    <a href="/courses" class="offer-btn">Grab The Offer <i class="fa fa-arrow-right"></i></a>
  </div>
</section>`;
...
.kr-logics-reference-home header.public-home-header {
  top: var(--public-trending-height, 0px);
}
...
.kr-logics-reference-home .mini-card-light {
  border-color: rgba(9, 87, 211, 0.25);
}
...
.kr-logics-reference-home .exam-mega .exam-link {
  ...
  color: #0957D3 !important;
  border-color: rgba(9, 87, 211, 0.2) !important;
}
.kr-logics-reference-home .exam-mega .exam-cat.active {
  background: rgba(9, 87, 211, 0.06) !important;
  border-color: rgba(9, 87, 211, 0.45) !important;
}
.kr-logics-reference-home .exam-mega .exam-link:hover {
  color: #0957D3 !important;
  border-color: #0957D3 !important;
}
.kr-logics-reference-home .hero-card,
.kr-logics-reference-home .mini-card-light,
...
.kr-logics-reference-home .faq-item {
  box-shadow: 0 14px 36px rgba(9, 87, 211, 0.08);
}
...
.kr-logics-reference-home .hero-quick-card {
  background: #ffffff;
  border-color: rgba(9, 87, 211, 0.2);
  box-shadow: 0 20px 45px rgba(9, 87, 211, 0.12);
}
...
.kr-logics-reference-home .hero-quick-card .hero-product-icon {
  background: #0957D3;
  color: #ffffff;
  box-shadow: 0 10px 22px rgba(9, 87, 211, 0.2);
}
...
.kr-logics-reference-home .hero-ad-slide {
  background:
    radial-gradient(circle at 88% 22%, rgba(9, 87, 211, 0.34), transparent 24%),
    linear-gradient(120deg, #0957D3 0%, #0957D3 58%, #ffffff 100%);
  color: #ffffff;
  display: flex;
  flex: 0 0 33.333%;
...
.kr-logics-reference-home .hero-ad-slide::after {
  ...
  border-radius: 18px;
  background:
    linear-gradient(135deg, rgba(255, 255, 255, 0.28), rgba(9, 87, 211, 0.10)),
...
.kr-logics-reference-home .hero-ad-slide.alt {
  background:
    ...
    linear-gradient(120deg, #ffffff 0%, #ffffff 52%, #0957D3 100%);
  color: #0957D3;
}
.kr-logics-reference-home .hero-ad-slide.dark {
  background:
    radial-gradient(circle at 88% 20%, rgba(9, 87, 211, 0.24), transparent 24%),
    linear-gradient(120deg, #0957D3 0%, #0957D3 58%, rgba(9, 87, 211, 0.8) 100%);
}
...
.kr-logics-reference-home .hero-exam-icon.bank,
.kr-logics-reference-home .hero-exam-icon.office,
.kr-logics-reference-home .hero-exam-icon.sbi,
.kr-logics-reference-home .hero-exam-icon.ibps {
  background: #0957D3;
  color: #ffffff;
}
...
.kr-logics-reference-home .why-kr-section {
  background: #ffffff;
  border-bottom: 1px solid rgba(9, 87, 211, 0.15);
  border-top: 1px solid rgba(9, 87, 211, 0.15);
  padding: 52px 5% 64px;
  text-align: center;
}
...
.kr-logics-reference-home .why-kr-icon {
  ...
  background: #ffffff;
  border-radius: 50%;
  box-shadow: 0 12px 28px rgba(9, 87, 211, 0.12);
  color: #0957D3;
  border: 2px solid rgba(9, 87, 211, 0.15);
  display: flex;
  font-size: 42px;
  height: 120px;
  justify-content: center;
...
.kr-logics-reference-home .faculty-avatar-img {
  width: 78px;
  height: 78px;
  border-radius: 50%;
...
.kr-logics-reference-home .testi-avatar-img {
  width: 38px;
  height: 38px;
  border-radius: 50%;
  object-fit: cover;
...
.kr-logics-reference-home .footer-socials a.fsoc {
  text-decoration: none;
}
...
const chromeGuardStyles = `
.public-trending-strip,
header.public-home-header,
...
header.public-home-header {
  ...
  top: var(--public-trending-height, 42px) !important;
...
footer.public-site-footer .public-site-footer-inner {
  width: 100% !important;
  max-width: none !important;
...
export function HomePageView({ initialData = null }: { initialData?: HomePageResponse | null }) {
  const [homeData, setHomeData] = useState<HomePageResponse | null>(initialData);

  useEffect(() => {
    if (initialData) return;
    fetchHomePageData().then(setHomeData);
  }, [initialData]);

  const videoItems = useMemo(() => {
    const dynamicVideos = youtubeUrlsToVideos(homeData?.settings.videos ?? []);
    return dynamicVideos.length > 0 ? dynamicVideos : defaultVideoItems;
  }, [homeData]);

  const studentStoryVideos = useMemo(() => {
    const dynamicVideos = youtubeUrlsToVideos(homeData?.settings.video_reviews ?? [], "Student Testimonial");
    return dynamicVideos.length > 0 ? dynamicVideos : defaultStudentStoryVideos;
  }, [homeData]);

  const repeatedStudentStoryVideos = useMemo(
    () => [...studentStoryVideos, ...studentStoryVideos, ...studentStoryVideos],
    [studentStoryVideos],
  );
  ...
  const pageSections = useMemo(() => {
    ...
    const settings = homeData ? normalizeHomePageSettings(homeData.settings) : null;
    const heroShowcaseMarkup = settings
      ? buildHeroShowcaseMarkup(settings.banners, settings)
      : defaultHeroShowcaseMarkup;
    const aboutVideoMarkup = settings
      ? buildAboutVideoMarkup(settings.about_us_video)
      : defaultAboutVideoMarkup;
    const dynamicPageMarkup = homeData && settings
      ? applyHomePageData(pageMarkup, settings)
      : stripHeroLeftStats(pageMarkup);
    const pageWithHeroShowcase = dynamicPageMarkup.replace(
      '<div class="hero-right">',
      `<div class="hero-right">${heroShowcaseMarkup}`,
    );
    const categoryStrip =
      buildCategoryChipsMarkup(settings?.category_chips ?? []) ||
      buildCategoryStripMarkup(homeData?.categories ?? []);
    const achieveOfferStrip = settings ? buildAchieveOfferMarkup(settings) : examCategoriesMarkup;
    const pageWithStrips = pageWithHeroShowcase.replace(
      heroAboutMarker,
      `</section>\n\n${categoryStrip || categoryStripMarkup}\n\n${achieveOfferStrip}\n\n<div class="divider"></div>\n\n<!-- ABOUT -->`,
    );
    const pageWithAboutVideo = pageWithStrips
      .replace('<div class="about-grid">', `<div class="about-grid">${aboutVideoMarkup}`);
    const pageWithAboutLayout = homeData
      ? pageWithAboutVideo
      : pageWithAboutVideo.replace(
    ...
    const [beforeCoursesMarkup = ""] = pageWithAboutLayout.split(coursesMarker);
    const withoutLegacyHeader = beforeCoursesMarkup.replace(/<!-- HEADER -->[\s\S]*?<\/header>\s*/i, "");
    const heroClose = withoutLegacyHeader.indexOf("</section>");
    const heroMarkup = heroClose >= 0 ? withoutLegacyHeader.slice(0, heroClose + "</section>".length) : withoutLegacyHeader;
    const afterHeroMarkup = heroClose >= 0 ? withoutLegacyHeader.slice(heroClose + "</section>".length) : "";
    const contactMarker = "<!-- CONTACT -->";
    const contactIndex = pageWithAboutLayout.indexOf(contactMarker);
    const rawAfterContact = contactIndex >= 0 ? pageWithAboutLayout.slice(contactIndex) : "";
    const footerMarker = "<footer";
    const footerIndex = rawAfterContact.indexOf(footerMarker);
    const contactOnlyMarkup = footerIndex >= 0 ? rawAfterContact.slice(0, footerIndex).trimEnd() : rawAfterContact;

    return {
      heroMarkup,
      afterHeroMarkup,
      afterContactMarkup: contactOnlyMarkup,
    };
  }, [homeData]);
  ...
  const handlePageClick = (event: MouseEvent<HTMLElement>) => {
    ...
    const bannerArrow = target.closest(".hero-ref-arrow");
    if (bannerArrow instanceof HTMLButtonElement) {
      const banner = bannerArrow.closest(".hero-ref-banner");
      const slides = banner?.querySelectorAll(".hero-ref-slide");
      const dots = banner?.querySelectorAll(".hero-ref-dots span");
      if (!slides?.length) return;

      const activeIndex = Array.from(slides).findIndex((slide) => slide.classList.contains("active"));
      const direction = bannerArrow.classList.contains("left") ? -1 : 1;
  ...
  return (
    <main className="kr-logics-reference-home" onClick={handlePageClick}>
        ...
        <style dangerouslySetInnerHTML={{ __html: chromeGuardStyles }} />
        <div dangerouslySetInnerHTML={{ __html: pageSections.heroMarkup }} />
        <HomeTopCourseTiles settings={homeData?.settings ?? null} />
        <div dangerouslySetInnerHTML={{ __html: pageSections.afterHeroMarkup }} />
        <KRLogicsVideos videos={videoItems} />
        <div className="divider" />
        <HomeFacultySection faculties={homeData?.faculties ?? []} />
        <StudentStoryVideos videos={repeatedStudentStoryVideos} />
        <HomeReviewsSection
          reviews={homeData?.reviews ?? []}
          playStoreUrl={
            homeData?.settings.play_store?.enabled ? homeData.settings.play_store.url : null
          }
        />
        <div dangerouslySetInnerHTML={{ __html: pageSections.afterContactMarkup }} />
      </main>
  );
}

function KRLogicsVideos({ videos }: { videos: HomeVideoItem[] }) {
  const [activeIndex, setActiveIndex] = useState(0);
  const [openVideo, setOpenVideo] = useState<HomeVideoItem | null>(null);
...
function StudentStoryVideos({ videos }: { videos: HomeVideoItem[] }) {
  const [openVideo, setOpenVideo] = useState<HomeVideoItem | null>(null);
        ...
        <div className="student-video-row" ref={rowRef}>
          {videos.map((video, index) => (
            ...
            >
              ...
              <div className="student-badge">{video.label ?? "Verified Success Story"}</div>
...
function VideoCard({ video, variant, onOpen }: { video: HomeVideoItem; variant: string; onOpen: (video: HomeVideoItem) => void }) {
  return (
    <button
      type="button"
      ...
      <div className="video-caption">
        {variant.includes("featured") ? (
          <>
            ...
            {video.date ? <div className="featured-date"><i className="fa fa-clock" /> {video.date}</div> : null}
          </>
        ) : (
          <>
            <span>KR Logics</span>
