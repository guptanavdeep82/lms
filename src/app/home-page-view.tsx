...
import { applyHomePageData, buildAchieveOfferMarkup, buildCategoryChipsMarkup, buildCategoryStripMarkup, buildHeroShowcaseMarkup, stripHeroLeftStats } from "@/lib/home-page-content";
...
.kr-logics-reference-home .about-section { display: none !important; }
...
export function HomePageView({ initialData = null }: { initialData?: HomePageResponse | null }) {
  ...
  const pageSections = useMemo(() => {
    ...
    const pageWithAboutLayout = pageWithStrips;
    ...
    const afterHeroMarkup = (heroClose >= 0 ? withoutLegacyHeader.slice(heroClose + "</section>".length) : "")
      .replace(/\s*<!-- ABOUT -->\s*/i, "")
      .replace(/<section class="about-section"[\s\S]*?<\/section>/i, "")
      .replace(/(<div class="divider"><\/div>\s*){2,}/g, '<div class="divider"></div>\n\n');
