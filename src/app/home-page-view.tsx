...
import { HomeFacultySection, HomeOfferBar, HomeReviewsSection, HomeTopCourseTiles } from "@/components/home/HomeDynamicSections";
import { applyHomePageData, buildAchieveOfferMarkup, buildHeroShowcaseMarkup, stripHeroLeftStats } from "@/lib/home-page-content";
...
export function HomePageView({ initialData = null }: { initialData?: HomePageResponse | null }) {
  ...
  return (
    <main className="kr-logics-reference-home" onClick={handlePageClick}>
        ...
        <HomeOfferBar settings={homeData?.settings ?? null} />
