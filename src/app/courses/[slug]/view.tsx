...
export default function CourseDetailView() {
  ...
  const [payload, setPayload] = useState<CourseDetailResponse | null>(null);
    ...
    return (
      <PublicPageShell active="courses" className="min-h-screen bg-[#f7f6ef] text-[#151515]">
        <div className="flex min-h-[50vh] items-center justify-center gap-2 text-sm font-semibold text-slate-600">
          <Loader2 className="size-5 animate-spin" /> Loading course...
        </div>
      </PublicPageShell>
    );
  }
    ...
    return (
      <PublicPageShell active="courses" className="min-h-screen bg-[#f7f6ef] text-[#151515]">
        <div className="mx-auto max-w-2xl px-4 py-20 text-center">
          <h1 className="font-['Sora'] text-3xl font-extrabold">Course not found</h1>
          <Link href="/courses" className="mt-6 inline-block text-sm font-bold text-[#8a6500]">← Back to courses</Link>
        </div>
      </PublicPageShell>
    );
  }
