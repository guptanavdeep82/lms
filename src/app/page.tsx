...
import { applyHomePageData, applyTopCoursesMarkup, buildAboutVideoMarkup, buildHeroShowcaseMarkup } from "@/lib/home-page-content";
...
const defaultHeroShowcaseMarkup = buildHeroShowcaseMarkup([]);
...
export default function Home() {
  ...
  const pageSections = useMemo(() => {
    ...
    const heroShowcaseMarkup = homeData
      ? buildHeroShowcaseMarkup(homeData.settings.banner_images)
    ...
    const dynamicPageMarkup = homeData ? applyHomePageData(pageMarkup, homeData.settings) : pageMarkup;
