...
export default function Home() {
  ...
  const pageSections = useMemo(() => {
    ...
    const dynamicPageMarkup = homeData
      ? applyHomePageData(
          pageMarkup,
          homeData.settings,
          homeData.faculties,
    ...
    return { beforeMockMarkup, mockToFaqMarkup, afterFaqMarkup, faqMarker };
  }, [homeData]);
  ...
  return (
    <main className="kr-logics-reference-home" onClick={handlePageClick}>
      ...
      <div dangerouslySetInnerHTML={{ __html: pageSections.mockToFaqMarkup }} />
      <StudentStoryVideos videos={repeatedStudentStoryVideos} />
      <div dangerouslySetInnerHTML={{ __html: `${pageSections.faqMarker}${pageSections.afterFaqMarkup}` }} />
    </main>
  );
}
