...
const defaultHeroShowcaseMarkup = `<div class="hero-showcase-stack">
...
.kr-logics-reference-home {
  ...
  --gold: #0066ff;
  --gold2: #0066ff;
  --gold3: rgba(0, 102, 255, 0.06);
  --light: #ffffff;
  --light2: #ffffff;
  --border: rgba(0, 102, 255, 0.15);
  --text: #0066ff;
  --gray: rgba(0, 102, 255, 0.7);
  background: #ffffff;
}
...
.kr-logics-reference-home .hero {
  background:
    radial-gradient(circle at 75% 18%, rgba(0, 102, 255, 0.20), transparent 28%),
    linear-gradient(135deg, #0066ff 0%, #0066ff 52%, #ffffff 52%, #ffffff 100%);
  min-height: 760px;
  padding-top: 70px;
  padding-bottom: 52px;
}
...
.kr-logics-reference-home .faq-item {
  box-shadow: 0 14px 36px rgba(0, 102, 255, 0.08);
}
...
.kr-logics-reference-home .hero-ad-slide {
  background:
    radial-gradient(circle at 88% 22%, rgba(0, 102, 255, 0.34), transparent 24%),
    linear-gradient(120deg, #0066ff 0%, #0066ff 58%, #ffffff 100%);
  color: #ffffff;
  display: flex;
  flex: 0 0 33.333%;
...
.kr-logics-reference-home .hero-ad-slide::after {
  ...
  border-radius: 18px;
  background:
    linear-gradient(135deg, rgba(255, 255, 255, 0.28), rgba(0, 102, 255, 0.10)),
...
.kr-logics-reference-home .hero-ad-slide.alt {
  background:
    ...
    linear-gradient(120deg, #ffffff 0%, #ffffff 52%, #0066ff 100%);
  color: #0066ff;
}
.kr-logics-reference-home .hero-ad-slide.dark {
  background:
    radial-gradient(circle at 88% 20%, rgba(0, 102, 255, 0.24), transparent 24%),
    linear-gradient(120deg, #0066ff 0%, #0066ff 58%, rgba(0, 102, 255, 0.8) 100%);
}
...
@media (max-width: 1180px) {
  .kr-logics-reference-home .hero {
    background:
      radial-gradient(circle at 80% 0%, rgba(0, 102, 255, 0.18), transparent 34%),
      #0066ff;
  }
  .kr-logics-reference-home .hero-inner {
