...
.kr-logics-reference-home .hero-ad-slide {
  background:
    radial-gradient(circle at 88% 22%, rgba(124, 58, 237, 0.34), transparent 24%),
    linear-gradient(120deg, #7c3aed 0%, #7c3aed 58%, #ffffff 100%);
  color: #ffffff;
  display: flex;
  flex: 0 0 33.333%;
...
.kr-logics-reference-home .hero-ad-slide::after {
  ...
  border-radius: 18px;
  background:
    linear-gradient(135deg, rgba(255, 255, 255, 0.28), rgba(124, 58, 237, 0.10)),
...
.kr-logics-reference-home .hero-ad-slide.alt {
  background:
    ...
    linear-gradient(120deg, #ffffff 0%, #ffffff 52%, #7c3aed 100%);
  color: #7c3aed;
}
.kr-logics-reference-home .hero-ad-slide.dark {
  background:
    radial-gradient(circle at 88% 20%, rgba(124, 58, 237, 0.24), transparent 24%),
    linear-gradient(120deg, #7c3aed 0%, #7c3aed 58%, rgba(124, 58, 237, 0.8) 100%);
}
...
.kr-logics-reference-home .hero-banner-card {
  background:
    ...
    linear-gradient(120deg, #7c3aed 0%, #7c3aed 54%, rgba(124, 58, 237, 0.85) 100%),
    url("/banking-mock-test-hero.png") center / cover no-repeat;
  background-blend-mode: normal, multiply, luminosity;
  border-radius: 18px;
  border: 1px solid rgba(255, 255, 255, 0.3);
  box-shadow: 0 20px 45px rgba(124, 58, 237, 0.24);
  color: #ffffff;
  display: flex;
  flex-direction: column;
  justify-content: center;
