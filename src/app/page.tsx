...
import { applyHomePageData, applyTopCoursesMarkup, buildAboutVideoMarkup, buildHeroShowcaseMarkup, stripHeroLeftStats } from "@/lib/home-page-content";
import { fetchHomePageData, youtubeUrlsToVideos, type HomePageResponse, type HomeVideoItem } from "@/lib/home-page";
...
export default function Home() {
  ...
  const pageSections = useMemo(() => {
    ...
    const heroShowcaseMarkup = homeData
      ? buildHeroShowcaseMarkup(homeData.settings.banner_images, homeData.settings)
      : defaultHeroShowcaseMarkup;
    const aboutVideoMarkup = homeData
      ? buildAboutVideoMarkup(homeData.settings.about_us_video)
      : defaultAboutVideoMarkup;
    const dynamicPageMarkup = homeData ? applyHomePageData(pageMarkup, homeData.settings) : stripHeroLeftStats(pageMarkup);
