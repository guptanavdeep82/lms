...
import { applyHomePageData, applyTopCoursesMarkup, buildAboutVideoMarkup, buildAchieveOfferMarkup, buildCategoryStripMarkup, buildHeroShowcaseMarkup, buildTrendingStripMarkup, buildWhyKrLogicsMarkup, stripHeroLeftStats } from "@/lib/home-page-content";
...
export default function Home() {
  ...
  const pageSections = useMemo(() => {
    ...
    const categoryStrip = buildCategoryStripMarkup(homeData?.categories ?? []);
  ...
  return (
    <>
      <main className="kr-logics-reference-home" onClick={handlePageClick}>
        ...
        <HomeReviewsSection reviews={homeData?.reviews ?? []} />
