        ...
        <div className="relative px-4 pb-5 pt-4 text-white" style={{ background: theme.gradient }}>
          ...
          <div className="relative z-10">
            <div className="mb-3 flex items-start justify-between gap-2">
              ...
              <span className="rounded-md bg-[#0957D3] px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-wide text-white">
            ...
            <div
              className="mt-3 inline-block max-w-full rounded-md px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-[0.08em] text-[#0E318D]"
