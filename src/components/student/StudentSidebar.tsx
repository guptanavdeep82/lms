      ...
      <div className="flex h-[78px] items-center gap-3 border-b border-[#e4e8f1] px-6">
        <Link href="/" className="flex min-w-0 items-center gap-3 transition hover:opacity-90" onClick={onNavigate}>
          ...
          <div className="min-w-0">
            <p className="text-sm font-extrabold leading-tight text-[#0066ff]">KR Logics</p>
            <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#0066ff]/60">Student LMS</p>
          </div>
        </Link>
      </div>
