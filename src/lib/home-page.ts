  ...
  top_course_tiles: [
    {
      ...
      tone: "lavender",
      items: [
        { label: "Elite pass", url: "/courses/elite-pass", icon: "fa-crown" },
        { label: "Mock test", url: "/mock-tests", icon: "fa-clipboard-list" },
        { label: "Elite success kit", url: "/courses/elite-success-kit", icon: "fa-box-open" },
        { label: "C.A", url: "/courses/current-affairs-book-and-quiz", icon: "fa-newspaper" },
      ],
    },
    {
      title: "Video course",
    ...
    },
    {
      ...
      tone: "rose",
      items: [
        { label: "YouTube", url: "https://youtube.com/@kaneeshreenalogics?si=3THBf_Wcv2HTAnvv", icon: "fa-youtube" },
        { label: "Instagram", url: "https://www.instagram.com/kr_logics?stkn=aWVqZmRlaWpjMG54", icon: "fa-instagram" },
        { label: "Telegram channel", url: "https://t.me/kaneeshreenalogics", icon: "fa-telegram-plane" },
        { label: "Telegram group", url: "https://t.me/kaneeshmathsdiscussion", icon: "fa-telegram" },
      ],
    },
  ],
  play_store: {
